...
const createdGroupChats = asyncHandler(async (req, res) => {
...
module.exports = {accessChat,fetchChats,createdGroupChats,renameGroup,addToGroup,removeFromGroup};